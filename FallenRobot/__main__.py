...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(f"@{SUPPORT_CHAT}", "https://telegra.ph/file/36be820a8775f0bfc773e.jpg", caption="ᕼᗩTᕼOᗪI ᙭ ᗷOT 🇮🇳ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ  ★彡[ᴀᴀᴋᴀꜱʜ xᴅ]彡★ 🇮🇳")
        except Unauthorized:
            LOGGER.warning(
